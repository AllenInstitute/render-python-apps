...
example_parameters={
    ...
    "tilepairfile":"/nas3/data/S3_Run1_Jarvis/processed/tilepairfiles/tilepairs-dz10-0-694-nostitch-Stitched_DAPI_1_Lowres_68_to_112.json",
...
class QCPointMatchResultsParameters(RenderParameters):
    ...
    tilepairfile = InputFile(required=True, 
...
class QCPointMatchResults(RenderModule):
    ...
    def run(self):
        stack = self.args['input_file']
        with open(self.args['tilepairfile'],'r') as fp:
            self.tilepairjson = json.load(fp)
        print tilepairjson['renderParametersUrlTemplate']
