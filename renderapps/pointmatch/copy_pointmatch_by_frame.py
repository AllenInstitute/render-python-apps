...
example_parameters={
    ...
    "input_matchcollection":"TESTGEPHYRINCOLLECTION",
    "output_matchcollection":"TESTCONVERTEDGEPHYRINCOLLECTION",
    "input_stack":"Rough_Aligned_68_to_112_Gephyrin",
    "output_stack":"Rough_Aligned_68_to_112_DAPI_1"
}


def find_corresponding_tile(render,section,input_id,input_stack,output_stack):
    input_tilespec = render.run(renderapi.tilespec.get_tile_spec,input_stack,input_id)
...
def copy_point_matches_by_frame(render,
    ...
    for psection in pgroups:
		matches = renderapi.pointmatch.get_matches_with_group(input_matchcollection,psection,render=render)
		match0 = matches[0]
