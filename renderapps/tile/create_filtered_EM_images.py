...
def filter_em_image(path_in,path_out,sat_pix,grid_size,contrast_adjust,clip_limit,vert_flip):
    ...
    img = (img - 128)*contrast_adjust + 128
    ...
    clahe2 = cv2.createCLAHE(clipLimit=clip_limit,
...
def process_z(render,input_stack,sat_pix,grid_size,contrast_adjust,clip_limit,vert_flip,z):
...
class FilterEMModule(RenderModule):
    ...
    def run(self):
        ...
        mypartial = partial(process_z,
                            ...
                            self.args['sat_pix']/100,
                            self.args['clahe_size'],
                            self.args['contrast_adjust'],
                            self.args['clahe_clip_limit'],
                            self.args['vert_flip'])
