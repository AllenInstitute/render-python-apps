...
from pathos.mulitprocessing import Pool
...
if __name__ == '__main__':
    ...
    def process_z(render,input_stack,tform,z):
        ...
        tilespecs = render.run(renderapi.tilespecs.get_z_values_for_stack(input_stack,z))
        ...
        renderapi.utils.renderdump(tilespecs,tid)
        #return the filepath
        return tfile
    ...
    renderapi.client.import_jsonfiles_parallel(output_stack,json_files,poolsize=mod.args['pool_size'])
